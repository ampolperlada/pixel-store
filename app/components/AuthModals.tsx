...
interface AuthContextType {
  ...
  setupTwoFactorAuth: () => Promise<string>;
  validateTwoFactorCode: (code: string) => Promise<boolean>;
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        {mode === 'signup' && !emailVerificationSent && (
          <div className="bg-gradient-to-br from-purple-900 to-blue-900 p-6 md:p-8 rounded-lg border-2 border-pink-400 shadow-lg shadow-pink-500/50 relative overflow-hidden">
            <ScanLines />
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white/10 to-transparent opacity-50"></div>
            
            <h2 className="text-3xl font-bold text-center mb-4 text-pink-300 tracking-wide">
              <span className="relative inline-block">
            ...
            <div className="mt-4 text-center text-pink-300">
