...
const LoginModal: React.FC<LoginModalProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'credentials' | 'wallet'>('credentials');
  ...
  const validateForm = (): boolean => {
    ...
    if (!captchaToken && activeTab === 'credentials') {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="relative w-full max-w-md bg-gradient-to-br from-gray-900 via-gray-800 to-black p-8 rounded-xl border border-cyan-500 shadow-lg shadow-cyan-500/20">
        <button
          onClick={onClose}
        ...
        <div className="flex border-b border-gray-700 mb-6">
          <button
            className={`flex-1 py-2 font-medium ${activeTab === 'credentials' ? 'text-cyan-400 border-b-2 border-cyan-400' : 'text-gray-400'}`}
            onClick={() => setActiveTab('credentials')}
          >
            Email Login
          </button>
          <button
            className={`flex-1 py-2 font-medium ${activeTab === 'wallet' ? 'text-cyan-400 border-b-2 border-cyan-400' : 'text-gray-400'}`}
        ...
        {activeTab === 'credentials' ? (
          <>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full mt-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-cyan-500/20"
              >
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 text-center">
              Don't have a wallet? <button className="text-cyan-400 hover:underline">Learn more</button>
            </p>
          </div>
        )}
