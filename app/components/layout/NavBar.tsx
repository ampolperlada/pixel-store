        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-4">
              ...
              <Link
                href="/waitlist"
                className="block w-full text-center bg-gradient-to-r from-pink-600 to-purple-600 text-white py-2 rounded-lg"
              >
                Join Waitlist
              </Link>
            </div>
...
const MobileNavLink = ({ href, children }: MobileNavLinkProps) => (
  <Link href={href} className="block text-gray-300 hover:text-white">
    {children}
  </Link>
);
