...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\pixel\\pixel-store-web\\backend\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\pixel\\pixel-store-web\\backend\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider     = \"postgresql\"\n  url          = env(\"DATABASE_URL\") // Will now use Session Pooler\n  relationMode = \"prisma\"\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "b5af193a90c7fedf86cfbd047a56caa6bb85701392842bf1019708f851e5d745",
  "copyEngine": true
}
